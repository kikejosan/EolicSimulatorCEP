...
<ul class="sidebar-menu">
    <li class="header"  style="background-color:#b4cce4;"><strong>Menú de Navegación</strong></li>
    <li class="a"><a href="<?php echo $this->Url->build('/rankingprods/introProductividad'); ?>"><i class="fa fa-fw fa-area-chart"></i><span>Productividad</span></a></li>
    <li class="a"><a href="<?php echo $this->Url->build('/estadisticodiarios/introRendimiento'); ?>"><i class="fa fa-fw fa-bar-chart-o"></i></i> <span>Rendimiento</span></a></li>
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-database"></i><span>Index de Rendimiento</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/estadisticodiarios'); ?>"><i class="fa fa-circle-o"></i> Estadisticos diarios</a></li>
            <li><a href="<?php echo $this->Url->build('/bajadaderendimientos'); ?>"><i class="fa fa-circle-o"></i> Bajadas de rendimiento</a></li>
            <li><a href="<?php echo $this->Url->build('/fueras'); ?>"><i class="fa fa-circle-o"></i> Fueras</a></li>
        </ul>
    </li>
    
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-database"></i></i><span>Index de Productividad</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/rankingprods'); ?>"><i class="fa fa-circle-o"></i>Rankings</a></li>
            <li><a href="<?php echo $this->Url->build('/escalas'); ?>"><i class="fa fa-circle-o"></i>Escalas</a></li>
            <li><a href="<?php echo $this->Url->build('/transicions'); ?>"><i class="fa fa-circle-o"></i>Transiciones</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-database"></i></i><span>Index Estructural</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/parques'); ?>"><i class="fa fa-circle-o"></i>Parques</a></li>
            <li><a href="<?php echo $this->Url->build('/aeros'); ?>"><i class="fa fa-circle-o"></i>Aeros</a></li>
            <li><a href="<?php echo $this->Url->build('/users'); ?>"><i class="fa fa-circle-o"></i>Usuarios</a></li>
            <li><a href="<?php echo $this->Url->build('/UserParques'); ?>"><i class="fa fa-circle-o"></i> Users_Parques</a></li>
        </ul>
    </li>
    <!--
    <li class="a"><a href="<?php echo $this->Url->build('/rankingprods/pruebahigh'); ?>"> Prueba de HighCharts</a></li>
