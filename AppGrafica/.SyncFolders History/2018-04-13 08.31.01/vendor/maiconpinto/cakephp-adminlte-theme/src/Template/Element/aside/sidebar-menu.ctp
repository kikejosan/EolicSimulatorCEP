...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-dashboard"></i> <span>Tablas MySQL</span>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-dashboard"></i> <span>Tablas MongoDB</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/rankingprods'); ?>"><i class="fa fa-circle-o"></i> RankingProds</a></li>
