    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $estadisticodiario->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $estadisticodiario->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $estadisticodiario->id], ['confirm' => __('Are you sure you want to delete # {0}?', $estadisticodiario->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
