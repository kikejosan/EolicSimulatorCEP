...
<ul class="sidebar-menu">
    ...
    <li class="a"><a href="<?php echo $this->Url->build('/rankingprods/introduccion'); ?>"><i class="fa fa-fw fa-bar-chart-o"></i> <span>Productividad</span></a></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-list"></i><span>Index de Rendimiento</span>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-list"></i><span>Index de Productividad</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
