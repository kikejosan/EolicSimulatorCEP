...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-list"></i><span>Tablas MySQL</span>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $this->Url->build('/windeventrs'); ?>"><i class="fa fa-circle-o"></i> WindEventrs</a></li>
            <li><a href="<?php echo $this->Url->build('/Estadisticosdiarios'); ?>"><i class="fa fa-circle-o"></i> Estadisticos diarios</a></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-fw fa-list"></i><span>Tablas MongoDB</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $this->Url->build('/cambioinicios'); ?>"><i class="fa fa-circle-o"></i>Cambios</a></li>
            <li><a href="<?php echo $this->Url->build('/transicions'); ?>"><i class="fa fa-circle-o"></i>Transiciones</a></li>
            <li><a href="<?php echo $this->Url->build('/fluctuaprods'); ?>"><i class="fa fa-circle-o"></i>Fluctuaciones</a></li>
        </ul>
    </li>
